let debug,createClient,stripAnsi,format,errorSerializer;_2d5‍.x([["createLogger",()=>createLogger]]);_2d5‍.w("debug",[["default",["debug"],function(v){debug=v}]]);_2d5‍.w("node-loggly-bulk/lib/loggly/client",[["createClient",["createClient"],function(v){createClient=v}]]);_2d5‍.w("strip-ansi",[["default",["stripAnsi"],function(v){stripAnsi=v}]]);_2d5‍.w("util",[["format",["format"],function(v){format=v}]]);_2d5‍.w("./logSerializers",[["errorSerializer",["errorSerializer"],function(v){errorSerializer=v}]]);/* eslint-disable no-console */
...
const handleRejection = reason => _2d5‍.g.console.error('Unhandled promise rejection:', reason);
...
const logVerbose = (type, args) => {
  ...
  const log = type => (...args) => {
    ...
    else _2d5‍.g.console[type](...messages);
