let checkout,findMergeBase,getUpdateMessage,isClean,isUpToDate,installDependencies,createTask,transitionTo,mergeBaseNotFound,workspaceNotClean,workspaceNotUpToDate,checkoutMergeBase,initial,installingDependencies,lookupMergeBase,pending,success,runRestoreWorkspace;_2d5‍.x([["runPrepareWorkspace",()=>runPrepareWorkspace],["default",()=>_2d5‍.o]]);_2d5‍.w("../git/git",[["checkout",["checkout"],function(v){checkout=v}],["findMergeBase",["findMergeBase"],function(v){findMergeBase=v}],["getUpdateMessage",["getUpdateMessage"],function(v){getUpdateMessage=v}],["isClean",["isClean"],function(v){isClean=v}],["isUpToDate",["isUpToDate"],function(v){isUpToDate=v}]]);_2d5‍.w("../lib/installDependencies",[["default",["installDependencies"],function(v){installDependencies=v}]]);_2d5‍.w("../lib/tasks",[["createTask",["createTask"],function(v){createTask=v}],["transitionTo",["transitionTo"],function(v){transitionTo=v}]]);_2d5‍.w("../ui/messages/errors/mergeBaseNotFound",[["default",["mergeBaseNotFound"],function(v){mergeBaseNotFound=v}]]);_2d5‍.w("../ui/messages/errors/workspaceNotClean",[["default",["workspaceNotClean"],function(v){workspaceNotClean=v}]]);_2d5‍.w("../ui/messages/errors/workspaceNotUpToDate",[["default",["workspaceNotUpToDate"],function(v){workspaceNotUpToDate=v}]]);_2d5‍.w("../ui/tasks/prepareWorkspace",[["checkoutMergeBase",["checkoutMergeBase"],function(v){checkoutMergeBase=v}],["initial",["initial"],function(v){initial=v}],["installingDependencies",["installingDependencies"],function(v){installingDependencies=v}],["lookupMergeBase",["lookupMergeBase"],function(v){lookupMergeBase=v}],["pending",["pending"],function(v){pending=v}],["success",["success"],function(v){success=v}]]);_2d5‍.w("./restoreWorkspace",[["runRestoreWorkspace",["runRestoreWorkspace"],function(v){runRestoreWorkspace=v}]]);
