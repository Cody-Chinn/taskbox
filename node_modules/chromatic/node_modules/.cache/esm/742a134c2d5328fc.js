_2d5‍.x([["initial",()=>initial],["authenticating",()=>authenticating],["authenticated",()=>authenticated],["invalidToken",()=>invalidToken]]);const mask = secret => '*'.repeat(secret.length - 4) + secret.substr(-4);
