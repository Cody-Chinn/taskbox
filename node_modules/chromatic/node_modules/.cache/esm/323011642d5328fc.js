let reportBuilder,path,createTask,transitionTo,baseStorybookUrl,wroteReport,initial,pending,success;_2d5‍.x([["generateReport",()=>generateReport],["default",()=>_2d5‍.o]]);_2d5‍.w("junit-report-builder",[["default",["reportBuilder"],function(v){reportBuilder=v}]]);_2d5‍.w("path",[["default",["path"],function(v){path=v}]]);_2d5‍.w("../lib/tasks",[["createTask",["createTask"],function(v){createTask=v}],["transitionTo",["transitionTo"],function(v){transitionTo=v}]]);_2d5‍.w("../lib/utils",[["baseStorybookUrl",["baseStorybookUrl"],function(v){baseStorybookUrl=v}]]);_2d5‍.w("../ui/messages/info/wroteReport",[["default",["wroteReport"],function(v){wroteReport=v}]]);_2d5‍.w("../ui/tasks/report",[["initial",["initial"],function(v){initial=v}],["pending",["pending"],function(v){pending=v}],["success",["success"],function(v){success=v}]]);
